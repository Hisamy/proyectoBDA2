...
public class SolicitarPlacas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(lblAgenciaFiscal, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, -1, -1));
        ...
        lblCostoLicencia.setText("Solicitar placas");
        jPanel2.add(lblCostoLicencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, -1, -1));

        lblCosto1.setFont(new java.awt.Font("Inter ExtraBold", 1, 15)); // NOI18N
        lblCosto1.setForeground(new java.awt.Color(109, 70, 107));
        lblCosto1.setText("Tipos de automovil");
        jPanel2.add(lblCosto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 140, -1));

        lblSeleccion.setFont(new java.awt.Font("Inter ExtraBold", 1, 15)); // NOI18N
        lblSeleccion.setText("Automovil nuevo");
        jPanel2.add(lblSeleccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 200, 120, -1));
        ...
        jPanel2.add(lblVigencia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 390, 350, -1));

        lblVigencia2.setFont(new java.awt.Font("Inter ExtraBold", 1, 15)); // NOI18N
        lblVigencia2.setText("Automovil usado");
        jPanel2.add(lblVigencia2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 130, -1));

        lblVigencia3.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia3.setText("Si el automóvil del cual quiere tramitar placas es ");
        jPanel2.add(lblVigencia3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 350, -1));

        lblVigencia4.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia4.setText("usado, es necesario cumplir con los siguientes ");
        jPanel2.add(lblVigencia4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 350, -1));

        lblVigencia5.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia5.setText("requisitos:");
        jPanel2.add(lblVigencia5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 350, -1));

        lblVigencia6.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia6.setText("•  Haber sido registrado previamente en el sistema.");
        jPanel2.add(lblVigencia6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, 290, -1));

        lblVigencia7.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia7.setText("•  Número de placas anteriores.");
        jPanel2.add(lblVigencia7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, 350, -1));

        lblVigencia8.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia8.setText("•  Licencia vigente.");
        jPanel2.add(lblVigencia8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 350, -1));

        lblVigencia9.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia9.setText("Costo: ");
        jPanel2.add(lblVigencia9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 370, 350, -1));
        ...
        jPanel2.add(btnSolicitarLicencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 450, 140, 32));

        btnSolicitarLicencia1.setBackground(new java.awt.Color(65, 34, 52));
        btnSolicitarLicencia1.setFont(new java.awt.Font("Inter ExtraBold", 1, 12)); // NOI18N
        ...
        jPanel2.add(btnSolicitarLicencia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 450, 140, 32));

        lblVigencia10.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia10.setText("•  $1,500");
        jPanel2.add(lblVigencia10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, 350, -1));

        lblVigencia11.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia11.setText("Si el automóvil del cual quiere tramitar placas es ");
        jPanel2.add(lblVigencia11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 250, 350, -1));

        lblVigencia12.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia12.setText("nuevo, es necesario cumplir con los siguientes ");
        jPanel2.add(lblVigencia12, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 350, -1));

        lblVigencia13.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia13.setText("requisitos:");
        jPanel2.add(lblVigencia13, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, 350, -1));

        lblVigencia14.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia14.setText("•  No haber sido registrado previamente.");
        jPanel2.add(lblVigencia14, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, 350, -1));

        lblVigencia15.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia15.setText("•  Número de serie, marca, linea (año), modelo del");
        jPanel2.add(lblVigencia15, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 330, 350, -1));

        lblVigencia16.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia16.setText("automóvil.");
        jPanel2.add(lblVigencia16, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, 350, -1));

        lblVigencia17.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia17.setText("•  Licencia vigente.");
        jPanel2.add(lblVigencia17, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 370, 350, -1));

        lblVigencia18.setFont(new java.awt.Font("Inter ExtraBold", 0, 12)); // NOI18N
        lblVigencia18.setText("•  Costo:");
        jPanel2.add(lblVigencia18, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 390, 350, -1));
