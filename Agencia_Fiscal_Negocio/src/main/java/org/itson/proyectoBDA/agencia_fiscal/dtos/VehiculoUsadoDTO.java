...
public class VehiculoUsadoDTO extends VehiculoDTO {
    ...
    public VehiculoUsadoDTO(String numero_placas_antiguas, String numero_serie, Integer modelo, String color, String marca, String linea, boolean licencia_vigente, ClienteDTO clienteDTO) {
