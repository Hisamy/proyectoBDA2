...
public class Registro_ClientesBO implements IRegistro_ClientesBO{
    ...
    /**
     * Registra un cliente. Convierte
     * el NuevoClienteDTO a cliente para poder mandar
     * los datos del cliente a la capa de persistencia.
     * @param nuevoCliente nuevo cliente que se está registrando
     * @return una variable de tipo Cliente
     * @throws PersistenciaException Por si no se puedo guardar
