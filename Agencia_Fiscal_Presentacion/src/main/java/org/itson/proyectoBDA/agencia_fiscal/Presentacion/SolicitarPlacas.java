...
public class SolicitarPlacas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCosto1.setText("Tipo de vehiculo");
        jPanel2.add(lblCosto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, 120, -1));

        lblSeleccion.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        lblSeleccion.setText("Vehiculo nuevo");
        ...
        lblVigencia2.setText("Vehiculo usado");
        ...
        btnSolicitarPlacaAutomovilNuevo.setText("Continuar");
        btnSolicitarPlacaAutomovilNuevo.addActionListener(new java.awt.event.ActionListener() {
